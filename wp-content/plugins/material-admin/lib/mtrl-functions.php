...
*/
        ...
        if(isset($value['topbar-submenu-hover-color'])){
            $str .= '"topbar-submenu-hover-color":"'.$value['topbar-submenu-hover-color'].'","redux_import_export":"","redux-backup":1}';
        }

        $str .= '"redux_import_export":"","redux-backup":1}';
...
add_action( 'admin_menu', 'mtrl_remove_redux_menu',12 );
function mtrl_remove_redux_menu() {
